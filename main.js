function main(){
    ...
    var animate = function(){
        if(!freeze){
            glMatrix.mat4.rotate(modmatrix, modmatrix, theta, [1,1,0]);
        }

        if(reset){
            glMatrix.mat4.copy(modmatrix, glMatrix.mat4.create());
            if(!freeze) freeze = true;
            reset = !reset;
        }

        if(rotateRight){
            glMatrix.mat4.rotate(modmatrix, modmatrix, theta, [0,-0.05,0]);
        }
        ...
        if(moveUp){
            glMatrix.mat4.translate(modmatrix, modmatrix, [0,0.05,0]);
        }
        ...
        if(moveRight){
            glMatrix.mat4.translate(modmatrix, modmatrix, [0.05,0,0]);
        }
        ...
        if(moveCloser){
            glMatrix.mat4.translate(modmatrix, modmatrix, [0,0,0.05]);
        }
